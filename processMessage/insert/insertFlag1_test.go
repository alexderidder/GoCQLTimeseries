...
////	test := model.Request{}
////	insert := ParseFlag1{[]byte{1, 0, 0, 0}, &test}
////	flag1 := Flag1{&insert}
...
//	insert := ParseFlag1{[]byte{1, 0, 0, 0}, []byte("{\"stoneID\":\"bf82e78d-24a2-470d-abb8-9e0a2720619f\",\"data\":[{\"time\":\"2018-11-14T10:16:26.7220151+01:00\",\"kWh\":3.3228004,\"watt\":3.0233014,\"pf\":4.702545}]}"), &test}
//	flag1 := Flag1{&insert}
...
//
//	test = model.InsertJSON{}
//	insert = ParseFlag1{[]byte{1, 0, 0, 0}, []byte("{\"data\":[{\"time\":\"2018-11-14T10:16:26.7220151+01:00\",\"kWh\":3.3228004,\"watt\":3.0233014,\"pf\":4.702545}]}"), &test}
//	assert.Equal(t, true, flag1.marshalBytes(), "Marshal byte went wrong")
//	assert.Equal(t, model.MissingStoneID, flag1.checkParameters(), "Check if stone ID is missing")
//
//	test = model.InsertJSON{}
//	insert = ParseFlag1{[]byte{1, 0, 0, 0}, []byte("{\"stoneID\":\"bf82e78d-24a2-470d-abb8-9e0a2720619f\"}"), &test}
//	assert.Equal(t, true, flag1.marshalBytes(), "Marshal byte went wrong")
//	assert.Equal(t, model.MissingData, flag1.checkParameters(), "Check if data is missing")
//}
