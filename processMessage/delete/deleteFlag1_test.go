...
func TestDeleteFlag1JSON(t *testing.T) {
	...
	message = []byte("{\"stoneID\":\"bf82e78d-24a2-470d-abb8-9e0a2720619f\",\"startTime\":\"1995-03-01T00:00:00Z\",\"endTime\":\"1995-02-01T00:00:00Z\"}")
	_, err = parseFlag1(&message)
	assert.Equal(t, model.MissingType, err, "Check for types missing")
}
