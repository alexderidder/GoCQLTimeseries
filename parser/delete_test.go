...
func TestDeleteParseJSON(t *testing.T) {
	test := model.DeleteJSON{}
	delete := Delete{[]byte("{\"stoneID\":\"bf82e78d-24a2-470d-abb8-9e0a2720619f\",\"types\":[\"w\",\"pf\",\"kwh\"],\"startTime\":\"1995-03-01T00:00:00Z\",\"endTime\":\"1995-02-01T00:00:00Z\"}"), &test}
	assert.Equal(t, true, delete.parseJSON(), "Marshal byte went wrong")
...
func TestDeleteRequirements(t *testing.T) {
	...
	delete := Delete{[]byte("{\"stoneID\":\"bf82e78d-24a2-470d-abb8-9e0a2720619f\",\"types\":[\"w\",\"pf\",\"kwh\"],\"startTime\":\"1995-03-01T00:00:00Z\",\"endTime\":\"1995-02-01T00:00:00Z\"}"), &test}
	assert.Equal(t, true, delete.parseJSON(), "Marshal byte went wrong")
	assert.Equal(t, model.Null, delete.checkParameters(), "Check if no error")

	test = model.DeleteJSON{}
	delete = Delete{[]byte("{\"types\":[\"w\",\"pf\",\"kwh\"],\"startTime\":\"1995-03-01T00:00:00Z\",\"endTime\":\"1995-02-01T00:00:00Z\"}"), &test}
	assert.Equal(t, true, delete.parseJSON(), "Marshal byte went wrong")
	assert.Equal(t, model.MissingStoneID, delete.checkParameters(), "Check if stone ID is missing")

	test = model.DeleteJSON{}
	delete = Delete{[]byte("{\"stoneID\":\"bf82e78d-24a2-470d-abb8-9e0a2720619f\",\"startTime\":\"1995-03-01T00:00:00Z\",\"endTime\":\"1995-02-01T00:00:00Z\"}"), &test}
	assert.Equal(t, true, delete.parseJSON(), "Marshal byte went wrong")
	assert.Equal(t, model.MissingType, delete.checkParameters(), "Check if types are missing")
}
